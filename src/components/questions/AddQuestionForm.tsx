...
export default function AddQuestionForm() {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <form className="card p-6 bg-base-100 shadow-xl border-primary border-l-4 flex flex-col gap-6">
        <div>
          <label className="block font-semibold text-base mb-2">Question</label>
          <RichEditor
        ...
        {answerType === "text" && (
          <div>
            <label className="block font-semibold text-base mb-2">Answer</label>
            <RichEditor
              className="input border-2 focus:input-primary"
              mode="balloon-always"
              minHeight="50px"
